...
get_human_classifications <- function(d){
  ...
  d1$props2 <- as.character(sprintf("%.2f", d1$props))
...
ggsave(paste0(folder,"/figure_08_human_sims.pdf"), width = 297, height = 210*2/3, scale=1.1, units = "mm", grob)
```
